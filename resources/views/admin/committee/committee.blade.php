...
@section('title', 'Data Panitia | ' . config('app.name'))
@section('title-1', 'Data Panitia')
@section('content')
    <div class="row">
        <div class="col-md-12">
    ...
    {{-- modal --}}
    @include('admin.committee.modal._modal')
@endsection
{{-- addons css --}}
@push('css')
@endpush
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#add').on('click', function() {
                $('#modal-title').html('Tambah Panitia');
                $('#btn')
            ...
            $('#form-feature').on('submit', function(event) {
                ...
                if ($('#action').val() == 'edit') {
                    url = "/admin/committee/update/" + uuid;
                }
            ...
            $(document).on('click', '.edit', function() {
                ...
                $.ajax({
                    url: '/admin/committee/' + userUuid,
                    dataType: 'JSON',
                    success: function(data) {
                        $('#modal-title').html('Edit Panitia')
                        $('#action').val('edit');
                        $('#name').val(data.name);
            ...
            $(document).on('click', '.delete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            method: "DELETE",
                            url: '/admin/committee/delete/' + user_id,
                            headers: {
